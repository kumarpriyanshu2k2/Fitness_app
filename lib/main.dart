...
class _MyAppState extends State<MyApp> {
  ...
  initState() {
    ...
    flutterLocalNotificationsPlugin.initialize(initializationSettings,onDidReceiveNotificationResponse: selectNotification);
  }
  ...
  void selectNotification(NotificationResponse) async {
