...
import 'package:fitness_app/screens/start_workout/bloc/start_workout_bloc.dart';
import 'package:fitness_app/screens/start_workout/page/start_workout_page.dart';
import 'package:fitness_app/screens/start_workout/widget/start_workout_video.dart';
import 'package:fitness_app/screens/workout_details_screen/bloc/workoutdetails_bloc.dart' as workout_bloc;
...
class StartWorkoutContent extends StatelessWidget {
  ...
  Widget _createVideo(BuildContext context) {
    ...
    return Container(
      height: 264,
      width: double.infinity,
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: ColorConstants.black),
