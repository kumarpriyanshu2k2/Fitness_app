...
class MapsStatistics extends StatefulWidget {
  const MapsStatistics({Key? key}) : super(key: key);

  @override
  State<MapsStatistics> createState() => _MapsStatisticsState();
}

class _MapsStatisticsState extends State<MapsStatistics> {
